...
enum ts_symbol_identifiers {
  ...
  aux_sym_context_definition_repeat1 = 55,
  aux_sym_function_definition_repeat1 = 56,
  aux_sym_function_definition_repeat2 = 57,
  aux_sym_use_statement_repeat1 = 58,
  aux_sym_use_statement_repeat2 = 59,
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [27] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_source_file_repeat1, 2, 0, 0), SHIFT_REPEAT(71),
  ...
  [68] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_context_definition_repeat1, 2, 0, 0), SHIFT_REPEAT(59),
  [71] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_context_definition_repeat1, 2, 0, 0), SHIFT_REPEAT(66),
  [74] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_context_definition_repeat1, 2, 0, 0),
  [76] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_context_definition_repeat1, 2, 0, 0), SHIFT_REPEAT(4),
  [79] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_context_definition_repeat1, 2, 0, 0), SHIFT_REPEAT(6),
  ...
  [102] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_use_statement, 7, 0, 0),
  [104] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_use_statement, 7, 0, 0),
  [106] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_binary_expression, 4, 0, 8),
  [108] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_binary_expression, 4, 0, 8),
  [110] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_bool_literal, 1, 0, 0),
  [112] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_bool_literal, 1, 0, 0),
  [114] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_context_definition, 5, 0, 2),
  [116] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_context_definition, 5, 0, 2),
  [118] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_variable_definition, 4, 0, 0),
  [120] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_variable_definition, 4, 0, 0),
  [122] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_context_definition, 4, 0, 2),
  [124] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_context_definition, 4, 0, 2),
  ...
  [130] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_function_definition, 10, 0, 10),
  [132] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_function_definition, 10, 0, 10),
  [134] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_use_statement, 8, 0, 0),
  [136] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_use_statement, 8, 0, 0),
  [138] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_use_statement, 4, 0, 7),
  [140] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_use_statement, 4, 0, 7),
  [142] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_function_definition, 8, 0, 9),
  [144] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_function_definition, 8, 0, 9),
  [146] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_function_definition, 9, 0, 9),
  [148] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_function_definition, 9, 0, 9),
  [150] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_function_definition, 9, 0, 10),
  [152] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_function_definition, 9, 0, 10),
  [154] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_return_statement, 3, 0, 1),
  [156] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_return_statement, 3, 0, 1),
  ...
  [180] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_function_definition_repeat2, 2, 0, 0), SHIFT_REPEAT(54),
  [183] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_function_definition_repeat2, 2, 0, 0), SHIFT_REPEAT(9),
  [186] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_function_definition_repeat2, 2, 0, 0),
  ...
  [196] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_function_definition_repeat1, 2, 0, 0), SHIFT_REPEAT(4),
  [199] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_function_definition_repeat1, 2, 0, 0), SHIFT_REPEAT(6),
  ...
  [216] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_parameter_definition, 3, 0, 5),
  [218] = {.entry = {.count = 1, .reusable = true}}, SHIFT(81),
  [220] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_function_definition_repeat1, 1, 0, 0),
  ...
  [234] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_use_statement_repeat1, 2, 0, 4),
  [236] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_use_statement_repeat1, 2, 0, 4), SHIFT_REPEAT(70),
  [239] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_use_statement_repeat2, 2, 0, 0), SHIFT_REPEAT(69),
  ...
  [248] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_qualified_name_repeat1, 2, 0, 4),
  [250] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_qualified_name_repeat1, 2, 0, 4), SHIFT_REPEAT(63),
  [253] = {.entry = {.count = 1, .reusable = true}}, SHIFT(125),
  [255] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_qualified_name_repeat1, 2, 0, 2),
  [257] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_use_statement_repeat1, 2, 0, 2),
  ...
  [267] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_variable_declaration, 4, 0, 6),
  ...
  [281] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_variable_declaration, 3, 0, 5),
